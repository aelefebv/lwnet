...
def main(folder_to_run, output_dir):
    ...
    model_name = 'big_wnet'
    model_path = 'experiments/big_wnet_drive_av'
    mask_path = None
    ...
    for idx, f in enumerate(files):
        ...
        if result_path is None:
            result_path = im_loc
            im_path_out = osp.join(result_path, im_name.rsplit('.', 1)[-2] + '_av.png')
            im_path_out_bin = osp.join(result_path, im_name.rsplit('.', 1)[-2] + '_bin_av.png')
        else:
...
if __name__ == '__main__':
    ...
    output_dir = '/Users/austin/test_files/eyes/out_av'
